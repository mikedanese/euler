	...
	for (x = 0; x < 19; ++x)
	{
		...
		for (y = 0; y < 19; ++y)
		{
			...
			if (x < 17)
			{
				...
				{
					*max = r;
					int m[4] = {*(v), *(v+1), *(v+2), *(v+3)};
					printf("%u %u %u %u \n", *(v), *(v+1), *(v+2), *(v+3));
				}
			}
			if (x < 17 && y < 17)
			{
				int rd = *(v)**(v+21)**(v+42)**(v+63);
				if (rd > *max)
				{
					*max = rd;
					int m[4] = {*(v), *(v+21), *(v+42), *(v+63)};
					printf("%u %u %u %u \n", *(v), *(v+21), *(v+42), *(v+63));
				}
			}
			if (y < 17)
			{
				int d = *(v)**(v+20)**(v+40)**(v+60);
				if (d > *max)
				{
					*max = d;
					int m[4] = {*(v), *(v+20), *(v+40), *(v+60)};
					printf("%u %u %u %u \n", *(v), *(v+20), *(v+40), *(v+60));
				}
			}
			if (x > 2 && y < 17)
			{
				int ld = *(v)**(v+19)**(v+38)**(v+57);
				if (ld > *max)
				{
					*max = ld;
					int m[4] = {*(v), *(v+19), *(v+38), *(v+57)};
					printf("%u %u %u %u \n", *(v), *(v+19), *(v+38), *(v+57));
				}
			}
